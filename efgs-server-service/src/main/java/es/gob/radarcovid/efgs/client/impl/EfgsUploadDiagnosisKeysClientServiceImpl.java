...
@Slf4j
public class EfgsUploadDiagnosisKeysClientServiceImpl implements EfgsUploadDiagnosisKeysClientService {
    ...
    public Optional<String> uploadDiagnosisKeys(UploadKeysPayloadDto uploadKeysPayload) {
        log.debug("Entering EfgsUploadDiagnosisKeysClientImpl.uploadDiagnosisKeys()");
        Optional<String> result = client.uploadDiagnosisKeys(uploadKeysPayload);
        log.debug("Leaving EfgsUploadDiagnosisKeysClientImpl.uploadDiagnosisKeys() with: {}", result);
        return result;
    }
